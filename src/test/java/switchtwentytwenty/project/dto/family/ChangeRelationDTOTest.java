...
class ChangeRelationDTOTest {
    ...
    @Test
    void testEquals() {
        ChangeRelationDTO changeRelationDTO1 = new ChangeRelationDTO("3", "Son");
        ChangeRelationDTO changeRelationDTO2 = new ChangeRelationDTO("3", "Son");
    ...
    void testEqualsFalseDifferentRelationID() {
        ChangeRelationDTO changeRelationDTO1 = new ChangeRelationDTO("3", "Son");
        ChangeRelationDTO changeRelationDTO2 = new ChangeRelationDTO("4", "Son");
    ...
    void testEqualsFalseDifferentnewDesignation() {
        ChangeRelationDTO changeRelationDTO1 = new ChangeRelationDTO("3", "Son");
        ChangeRelationDTO changeRelationDTO2 = new ChangeRelationDTO("3", "Father");
    ...
    void setRelationID() {
        ChangeRelationDTO changeRelationDTO1 = new ChangeRelationDTO("3", "Son");
        changeRelationDTO1.setRelationID("New");
        String expected = "New";
        String result = changeRelationDTO1.getRelationID();
