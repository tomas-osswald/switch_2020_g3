...
class PersonInputDTOAssemblerTest {
    ...
    void toInputAddFamilyMemberDTOTest(){
        AddFamilyMemberDTO addFamilyMemberDTO = new AddFamilyMemberDTO("admin@email.com","admin@email.com","Lisa","11/10/1992",123123321,919999111,"Rua de Cima","Porto","36B","4000-123");
        InputAddFamilyMemberDTO expected = new InputAddFamilyMemberDTO("admin@email.com","admin@email.com","Lisa","11/10/1992",123123321,919999111,"Rua de Cima","Porto","36B","4000-123");
    ...
    void toInputPersonDTOTest() {
        AddFamilyAndSetAdminDTO addFamilyAndSetAdminDTO = new AddFamilyAndSetAdminDTO("admin@email.com","Lisa","11/10/1992",123123321,919999111,"Rua de Cima","Porto","36B","4000-123","Simpson","11/03/2014");
        InputPersonDTO expected = new InputPersonDTO("admin@email.com","Lisa","11/10/1992",123123321,919999111,"Rua de Cima","Porto","36B","4000-123");
