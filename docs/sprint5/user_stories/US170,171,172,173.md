...
// first time account creation with no balance
public AccountData(OwnerID ownerID, Description description) {
...
}

// first time account creation with given balance
public AccountData(OwnerID ownerID, Movement movement, Description description) {
this.balance = movement.getMonetary();
this.movements.add(movement);
...
}

// when retrieving account from persistence (@AllArgsConstructor no fundo)
public AccountData(OwnerID ownerID, Description description, AccountID accountID, List<Movement> movements, Monetary balance) {
